...
docker run -d --name mongodb --network muezzin-net -p 27017:27017 mongo:latest
...
@REM create container of elasticsearch:
...
@REM  create images and containers for four services - run all the commands below from root-folder-project /the_muezzin:
